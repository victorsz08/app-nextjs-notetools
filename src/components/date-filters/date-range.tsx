    ...
    return (
        <div className="flex flex-col sm:flex-row items-center gap-2 p-4">
            <Popover>
                <PopoverTrigger>
                    <div
                        className="justify-start cursor-pointer text-left font-normal w-full 
                        rounded-sm text-slate-500 text-sm flex items-center gap-1 
                        border border-slate-300 sm:w-[300px] p-2 bg-white"
                    >
                ...
                <PopoverContent className="w-auto p-0 flex items-start gap-8" align="end">
                    ...
                    <Calendar
                        className="aria-selected:bg-purple-700"
                        initialFocus
                        mode="range"
